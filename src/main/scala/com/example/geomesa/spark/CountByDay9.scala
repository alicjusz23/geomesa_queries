 ...
 ***********************************************************************/
/*
 * Creates table tempor with joined gtd and global urban areas, when they are inside, prints 10 top rows of data frame
...
//    val sqlQuery2 = "alter table temp drop column __fid__"
    ...
    resultNewDataFrame.write
      ...
      .saveAsTable("tempor")
    resultNewDataFrame.show(10)
//    resultDataFrame.write.csv("/home/ala/Documents/xyz.csv")
